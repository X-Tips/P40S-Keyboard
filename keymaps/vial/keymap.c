...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[8] = LAYOUT( //R:Keypad                                                    
		KC_Q, KC_W, KC_E, KC_R, KC_T,                                             KC_PPLS, KC_P7, KC_P8, KC_P9, KC_PDOT, 
		KC_A, KC_S, KC_D, KC_F, KC_G,                                             KC_PMNS, KC_P4, KC_P5, KC_P6, KC_P0,           
		KC_Z, KC_X, KC_C, KC_V, KC_B,                                             KC_PAST, KC_P1, KC_P2, KC_P3, KC_BSPC,   
		KC_RGUI, KC_RALT, KC_RCTL, TO(0), KC_RSFT,                                KC_PSLS, LSFT_T(KC_PENT), KC_ESC, KC_TAB, KC_DEL)
}; 
